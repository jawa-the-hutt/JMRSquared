...
export default class API {
    ...
    getAdminByContactnumbers(contactNumbers) {
        return new Promise((resolve, reject) => {
            http
                .getJSON(this.makeGet(`/a/get/by/contactnumbers/${contactNumbers}`))
                .then(result => {
                    var answer = this.handleResponse(result);
                    if (answer) {
                        return resolve(result);
    ...
    getBusinessSettings(businessID) {
        return new Promise((resolve, reject) => {
            http
                .getJSON(this.makeGet("/settings/options/business/types"))
                .then(result => {
                    var answer = this.handleResponse(result);
                    if (answer) {
                        return resolve(result);
